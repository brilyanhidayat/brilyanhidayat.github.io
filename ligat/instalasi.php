    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2></h2>
            <p>Instalasi Pemanfaatan Tenaga Listrik adalah instalasi tenaga listrik yang digunakan untuk pemanfaatan tenaga listrik oleh konsumen akhir. <br><br>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6" data-aos="fade-up">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">TM</a></h4>
              <p class="description">Tegangan Menengah berkisar dari 1.000 volt (1 kV) s/d 35.000 volt (35 kV)</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="">2</i></div>
              <h4 class="title"><a href="">TR</a></h4>
              <p class="description">Tegangan Rendah berkisar dari 50 volt s/d 1.000 volt (1kV)</p>
            </div>
          </div>
