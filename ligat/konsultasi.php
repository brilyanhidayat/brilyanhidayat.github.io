      ...
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2></h2>
            ...
            <p>Konsultansi dalam Bidang Instalasi Tenaga Listrik</p><br>
        </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6" data-aos="fade-up">
            <div class="icon-box">
              ...
              <p class="description">Pelayanan Konsultansi subbidang PLTU, PLTG, PLTUG, PLTP, PLTA, PLTD, PLTN & PLTEBT dengan kualifikasi kecil, menengah atau besar.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p class="description">Pelayanan Konsultansi subbidang TET/TT dan Gardu Induk dengan kualifikasi kecil, menengah atau besar.</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p class="description">Pelayanan Konsultansi subbidang TM & TR dengan kualifikasi kecil, menengah atau besar.</p>
            </div>
          </div>
