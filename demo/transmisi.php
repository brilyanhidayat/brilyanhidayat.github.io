    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2></h2>
            <p>Transmisi tenaga listrik adalah proses penghantaran tenaga listrik secara besar-besaran dari pembangkit listrik, ke gardu listrik. Jalur yang terinterkoneksi untuk memfasilitasi penghantaran ini dikenal sebagai jaringan transmisi listrik. <br><br>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6" data-aos="fade-up">
            <div class="icon-box">
              <div class="icon"><i class="e">1</i></div>
              <h4 class="title"><a href="">TET / TT</a></h4>
              <p class="description">Tegangan Ekstra Tinggi / <br> Tegangan Tinggi</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="">2</i></div>
              <h4 class="title"><a href="">Gardu Induk</a></h4>
              <p class="description">Bagian dari sistem pembangkit, transmisi dan distribusi listrik.</p>
            </div>
          </div>
...
.banner {
  color: white;
  background: url('assets/img/transmisi-top.jpg') top left/cover no-repeat;
  height: 300px;
  display: flex;
